...
import { screePlot, MSEChart, biplot, scatterPlot } from "./plotGraphs.js";
...
export async function updateBiPlot(){
    ...
    biplotForm.append('num_components', 4); 
...
export async function updateScatterMatrix(){
    ...
    scatterForm.append('num_components', 4); // Specify the number of components for biplot
